...
data_final <- data3 %>% 
  ...
  mutate(j20j35mod = ifelse(j20j35 > 8, 8, j20j35)) %>% # yhdistetty j20j35 ja korvattu ääriarvot, tämä hyvä selittäjä
