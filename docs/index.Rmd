---
title: "Ocuupational Health Project"
author: "Anssi Ahokas"
date: "23/08/2020"
output: 
  html_document:
...
data %>% 
  ...
  ggplot(aes(x = answer)) + geom_bar(stat="count") +
...
simulations %>% 
  ...
  ggplot(aes(x = value, color = simulation)) + geom_density(alpha = 0.2)
```
...
Because we are interested only in ceratin things we will filter the data frame even further.
